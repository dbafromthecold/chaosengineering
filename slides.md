...
<!-- Risk matrix SVG — text colors fixed with explicit fill -->
<svg viewBox="0 0 760 560" width="760" height="560" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Likelihood vs Impact risk matrix">
  <!-- background -->
  <rect x="0" y="0" width="760" height="560" fill="#0e4650"/>

  <!-- title -->
  <text x="380" y="70" text-anchor="middle"
        font-family="Inter, system-ui, -apple-system, Segoe UI, Roboto, Helvetica, Arial, sans-serif"
        font-size="48" font-weight="800" letter-spacing="2"
        fill="#eadfcb">LIKELIHOOD–IMPACT MAP</text>
  ...
  <g transform="translate(110,130)">
    ...
    <!-- cells (top row is y=0). Colors: green/yellow/red -->
    <!-- Row 1 (top) -->
  ...
  <!-- axis labels (explicit fill so themes can't override) -->
  <text x="380" y="530" text-anchor="middle"
        font-family="Inter, system-ui, -apple-system, Segoe UI, Roboto, Helvetica, Arial, sans-serif"
        font-size="22" fill="#eadfcb">Impact</text>

  <text x="40" y="330" text-anchor="middle"
        font-family="Inter, system-ui, -apple-system, Segoe UI, Roboto, Helvetica, Arial, sans-serif"
        font-size="22" fill="#eadfcb" transform="rotate(-90 40 330)">Likelihood</text>
</svg>
